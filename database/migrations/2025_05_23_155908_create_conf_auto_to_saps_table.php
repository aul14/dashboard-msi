...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('conf_autotosap', function (Blueprint $table) {
            ...
            $table->double('paramete_1')->nullable();
            $table->double('paramete_2')->nullable();
            $table->double('paramete_3')->nullable();
            $table->double('paramete_4')->nullable();
            $table->double('paramete_5')->nullable();
            $table->double('paramete_6')->nullable();

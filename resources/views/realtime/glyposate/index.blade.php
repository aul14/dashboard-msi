...
@section('content')
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="col-md-12 mb-2">
                <a href="{{ route('glyposate.table') }}" class="btn btn-lg btn-primary w-100" style="height:70px;">
                    Table Parameter
                </a>
            </div>
            <div class="col-md-12 mb-2">
    ...
    @include('realtime.glyposate.modal.operation')
    @include('realtime.glyposate.modal.settings')
    @include('realtime.glyposate.modal.parameter_setting')

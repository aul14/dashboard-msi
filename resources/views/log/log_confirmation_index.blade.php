...
@section('content')
    ...
    <div class="row">
        <form action="{{ route('log_confirmation.index') }}" method="get">
            @csrf
            ...
            <div class="col-md-12 my-2 px-0">
                <a href="{{ route('log_confirmation.index') }}" class="btn btn-md btn-outline-warning">Refresh</a>
    ...
    <script>
        $(function() {
            ...
            $('.my-table').DataTable({
                ...
                ajax: {
                    type: "get",
                    url: '{{ route('log_confirmation.index') }}',
                    data: {

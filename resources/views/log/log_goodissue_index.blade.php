...
@section('content')
    ...
    <div class="row">
        <form action="{{ route('log_goodissue.index') }}" method="get">
            @csrf
            ...
            <div class="col-md-12 my-2 px-0">
                <a href="{{ route('log_goodissue.index') }}" class="btn btn-md btn-outline-warning">Refresh</a>
